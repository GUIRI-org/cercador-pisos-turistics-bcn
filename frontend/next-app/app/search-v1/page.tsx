...
// Experimental iteration — data layer kept identical to the main search, UI/UX free to evolve.
export default function SearchV1Page() {
  ...
  return (
    <ParallaxContainer>
      <AppNavbar secondaryHref="/search-v2" secondaryLabel="Alternative search" />
